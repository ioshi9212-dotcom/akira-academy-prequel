...
4. Писать сцену в формате из `gpt/scene_format.md`.
5. Не тянуть время по минутам.
6. Держать Акиру под управлением игрока.
7. После сцены обновлять state-файлы: отношения, репутацию, знания, слухи, предметы, локации, историю сцены.
